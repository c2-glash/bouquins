...
class LoginFormAuthenticator extends AbstractFormLoginAuthenticator implements PasswordAuthenticatedInterface
{
    ...
    public function onAuthenticationSuccess(Request $request, TokenInterface $token, string $providerKey)
    {
        ...
        /*recuperation du nom de la page dans les parametres de route*/
        ...
        /*recuperation des parametres de la route*/
        $params = $request->attributes->get('_route_params');
        /* ajout parametres get (avec query all pour avoir tous les params get) en écrasant params*/
    ...
    {
        /*Recuperation du name de la page du login */
